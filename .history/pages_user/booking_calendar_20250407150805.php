...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-3xl font-semibold mb-6 text-center">Booking Calendar</h1>
        ...
        <div class="flex justify-between items-center mb-6 max-w-lg mx-auto">
            ...
            <a href="?month=<?= $month == 1 ? 12 : $month - 1 ?>&year=<?= $month == 1 ? $year - 1 : $year ?>"
                class="flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-transform transform hover:scale-110">
                <span class="mr-3 text-lg">Previous</span>
            ...
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="absolute top-0 left-1/2 transform -translate-x-1/2 bg-green-600 text-white font-semibold rounded-full shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 px-6 py-3 flex items-center justify-center transition-all duration-300 ease-in-out">
                <span class="text-xl">&gt;</span> <!-- '>' as the 'greater than' symbol -->
            </a>
            <!-- Next Button -->
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="absolute top-2 left-1/2 transform -translate-x-1/2 bg-green-600 text-white font-bold rounded-full shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 px-6 py-3 flex items-center justify-center transition-all duration-300 ease-in-out">
                <span class="text-2xl">&gt;</span> <!-- '>' as the 'greater than' symbol -->
            </a>
