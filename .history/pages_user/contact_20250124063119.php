...
<body class="bg-gray-200">
    ...
    <div class="min-h-screen flex items-center shadow-2xl justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl w-full bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="contact_submit.php" method="POST" class="space-y-6 min-w-full">
                <!-- Instructions -->
