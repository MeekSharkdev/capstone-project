...
<body>
    ...
    <script>
        ...
        // Modal open and close functionality with smooth slide-up and slide-down animation
        ...
        viewBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                modal.classList.remove('opacity-0', 'transform', '-translate-y-20'); // Smooth slide-up effect
                modal.classList.add('transition-all', 'duration-500', 'opacity-100', 'translate-y-0'); // Enable smooth transition
            }, 10);
        });
        ...
        closeModalBtn.addEventListener('click', () => {
            ...
            modal.classList.add('opacity-0', '-translate-y-20'); // Add slide-down and fade-out effect
            setTimeout(() => {
                modal.classList.add('hidden'); // Hide the modal after the animation
            }, 500); // Match the duration of the fade-out and slide-down effect (500ms)
        });
