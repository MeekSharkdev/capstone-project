...
<head>
    ...
    <title>Appointment Mgmt. | Admin</title>
            ...
            <script>
                ...
                document.querySelectorAll('.new-btn').forEach(button => {
                    button.addEventListener('click', () => {
                        ...
                        const firstname = button.getAttribute('data-middlename');
                        const lastname = button.getAttribute('data-lastname');

                        // Populate the modal form fields
                        document.getElementById('bookingId').value = bookingId;
                        document.getElementById('recipientEmail').value = recipientEmail;
                        document.getElementById('emailSubject').value = `Booking Confirmation for ${firstname} ${middlename} ${lastname}`;
            ...
            fetch('update_booking.php', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        location.reload(); // Reload page to reflect the updated date
                    } else {
    ...
    <script>
        ...
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                modal.classList.remove('hidden'); // Show modal with animation
                setTimeout(() => {
                    modal.classList.add('transition-all', 'duration-500', 'opacity-100', 'translate-y-0'); // Smooth slide-up effect
                }, 10);
            });
