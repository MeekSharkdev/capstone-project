            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="relative z-0 w-full group">
                        ...
                        <label for="floating_civilstatus" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0
