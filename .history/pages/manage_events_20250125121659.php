                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td class="px-4 py-2 border">
                            ...
                            <a href="delete_event.php?id=<?php echo $row['event_id']; ?>" class="text-red-500">Delete</a><a href="../archive_event.php?id=<?php echo $row['event_id']; ?>" class="text-yellow-500">Archive</a> |
