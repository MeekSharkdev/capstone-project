        ...
        <?php if (!$success) : ?>
            <form method="POST" class="space-y-6 fade-in-slide-up" onsubmit="return validateForm()">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="relative z-0 w-full group">
                        <select name="civilstatus" id="civilstatus" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0
