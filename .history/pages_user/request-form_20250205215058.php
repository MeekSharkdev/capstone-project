...
<body class="bg-gray-200 h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-xl">
        ...
        <form action="" method="POST" class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-7xl mx-auto p-4 bg-white rounded-lg shadow-lg">
            <!-- First Name -->
            <div>
            ...
            <div>
                ...
                <input type="text" name="purpose" value="<?php echo htmlspecialchars($booking['purpose'] ?? ''); ?>" readonly class="w-full px-4 py-2 border rounded-lg mb-4">
            </div>

            <!-- Original Appointment Date -->
            <div>
                <label class="block font-medium">Original Appointment Date</label>
                <input type="text" value="<?php echo htmlspecialchars($booking['booking_date'] ?? ''); ?>" readonly class="w-full px-4 py-2 border rounded-lg mb-4 bg-gray-100 text-gray-500">
            </div>

            <!-- Choose New Date -->
            <div>
                <label class="block font-medium">Choose New Date</label>
                <input type="date" name="request_date" required class="w-full px-4 py-2 border rounded-lg mb-4" min="<?php echo date('Y-m-d'); ?>">
            </div>
