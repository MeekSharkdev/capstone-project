    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-2xl mt-10">
        ...
        <div class="mb-9">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">First Name:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['firstname']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Middle Name:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['middlename']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Last Name:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['lastname']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Gender:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['sex']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Civil Status:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['civilstatus']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Citizenship:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars($user['citizenship']); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Birthdate:</div>
                <div class="text-gray-800 pl-4 sm:text-left"><?php echo htmlspecialchars(date("F j, Y", strtotime($user['birthdate']))); ?></div>

                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Birth Place:</div>
        ...
        <div class="mb-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Phone Number:</div>
                ...
                <div class="font-medium text-gray-600 text-left sm:text-right pr-4">Email:</div>
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
            <a href="../pages_user/edit_profile.php" class="bg-blue-500 text-white px-6 py-2 rounded-full hover:bg-blue-600 transition duration-300 text-center">Edit Profile</a>
            <a href="dashboard.php" class="bg-gray-500 text-white px-6 py-2 rounded-full hover:bg-gray-600 transition duration-300 text-center">Back to Dashboard</a>
        </div>
    </div>
</body>
