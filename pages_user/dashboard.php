...
<body class="bg-gray-200">
    ...
    <section id="services" class="what-we-do mt-5 animate-up px-4">
        ...
        <div class="flex flex-wrap justify-center gap-6">
            <div class="w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/3">
                <div class="text-center p-6 bg-white rounded-lg shadow-md">
                    <h5 class="text-2xl font-semibold mb-4">Choose Your Certificate</h5>
                    <p class="text-gray-600 mb-6">Select the appropriate certificate and proceed to book your appointment.</p>

                    <!-- Image -->
                    <div class="flex justify-center mb-6">
                        <img src="../images/bookingimg.png" class="w-full max-w-md transition-transform duration-300 hover:scale-105" alt="Certificate of Indigency">
                    </div>

                    <!-- Book Button -->
                    <a href="./booking_calendar.php" class="inline-block bg-blue-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-600 transition-colors duration-300">Book Now</a>
                </div>
            </div>
        </div>
    ...
    <div class="team-description mt-48 mb-24 px-4 sm:px-6 lg:px-8">
        <div class="bg-gray-100 rounded-lg shadow-2xl p-6 animate-left">
            <h3 class="text-2xl sm:text-3xl font-semibold text-gray-800 text-center">Meet Our Development Team</h3>

            <!-- Team Member Section (Responsive Flex) -->
            <div class="mt-12 flex flex-col md:flex-row items-center md:items-start gap-8">
                <!-- Team Member Image -->
                <div class="flex justify-center md:justify-start">
                    <img src="../images/access.png" alt="Access Student" class="w-72 h-64 object-cover rounded-full border-4 border-gray-800">
                </div>

                <!-- Team Member Description -->
                <div class="text-justify space-y-4 text-gray-700 max-w-2xl">
                    <h4 class="text-xl font-medium text-gray-900">Access Student</h4>
                    <p>
                        Our team consists of skilled developers and creative problem-solvers who work collaboratively to design innovative and effective solutions. Together, we strive to deliver seamless and user-friendly experiences. We work with the latest technologies to ensure our solutions are both scalable and efficient, always aiming for the best possible user experience.
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var teamSection = document.querySelector('.team-description .animate-left');
