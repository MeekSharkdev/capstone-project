<?php
session_start(); // Ensure this is at the top of the page!

// Debugging to check session id
var_dump($_SESSION['bookings _id']); // This will print the session variable for debugging
...
if (isset($_SESSION['id'])) {
    ...
    die("User not logged in."); // If session variable is not set
}
?>
