...
$firstname = isset($booking['firstname']) ? $booking['firstname'] : '';
$middle_initial = isset($booking['middle_initial']) ? $booking['middle_initial'] : '';
$lastname = isset($booking['lastname']) ? $booking['lastname'] : '';
$phonenumber = isset($booking['phonenumber']) ? $booking['phonenumber'] : '';
$email = isset($booking['email']) ? $booking['email'] : '';
$booking_date = isset($booking['booking_date']) ? $booking['booking_date'] : '';
$purpose = isset($booking['purpose']) ? $booking['purpose'] : '';
