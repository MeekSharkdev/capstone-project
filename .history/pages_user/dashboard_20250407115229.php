            ...
            <div class="w-full max-w-lg">
                <div class="text-center p-4 bg-white rounded-lg shadow-md">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 mb-6">
                        <img src="../images/indigencyNew.jpg" class="img-fluid max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl transition-transform duration-300 hover:scale-105" alt="Certificate of Indigency">
                        <img src="../images/businesspermit.jpg" class="img-fluid max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl transition-transform duration-300 hover:scale-105" alt="Business Permit">
                        <img src="../images/brgyclrnc.jpg" class="img-fluid max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl transition-transform duration-300 hover:scale-105" alt="Barangay Clearance">
                    </div>
