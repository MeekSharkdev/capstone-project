...
// Fetch the latest booking details for the logged-in user based on their email
...
// Initialize $booking with empty data
$booking = [
    'firstname' => '',
    'middle_initial' => '',
    'lastname' => '',
...
// Check if booking data was found
if ($result->num_rows > 0) {
    $booking = $result->fetch_assoc();  // Fetch the booking details for the logged-in user
} else {
    // Display message if no booking is found
    $booking = null; // No booking found, set it as null
}
