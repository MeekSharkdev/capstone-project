...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-gray-800 text-white">
    <div class="h-full px-2 py-2 text-sm overflow-y-auto">
        <!-- Logo at the top with pop-up animation -->
        <div class="flex justify-center mb-4 logo-pop-up">
            <img src="../images/BRGY.__2_-removebg-preview.png" alt="Barangay Logo" class="h-16 w-auto">
        </div>
        ...
        <ul class="space-y-2">
            ...
            <li class="link-slide-in">
                <a href="./manage_inquiries.php" class="flex items-center px-4 py-2 hover:bg-gray-700 hover:scale-105 rounded transition-all duration-500">
                    <i class="fas fa-question-circle mr-4"></i> Manage Inquiries
                </a>
            </li>
            <li class="link-slide-in">
                <a href="./manage_admin.php" class="flex items-center px-4 py-2 hover:bg-gray-700 hover:scale-105 rounded transition-all duration-500">
                    <i class="fas fa-users-cog mr-4"></i> Admin Overview
                </a>
            </li>
            <li class="link-slide-in">
                <a href="./create_admin.php" class="flex items-center px-4 py-2 hover:bg-gray-700 hover:scale-105 rounded transition-all duration-500">
                    <i class="fas fa-user-plus mr-4"></i> Create Admin
                </a>
            </li>
            ...
            <li class="link-slide-in">
                <a href="./manage_events.php" class="flex items-center px-4 py-2 hover:bg-gray-700 hover:scale-105 rounded transition-all duration-500">
                    <i class="fas fa-calendar-plus mr-4"></i> Manage Events
                </a>
            </li>
            <li class="link-slide-in">
                <a href="./archive_storage.php" class="flex items-center px-4 py-2 hover:bg-gray-700 hover:scale-105 rounded transition-all duration-500">
                    <i class="fas fa-calendar-plus mr-4"></i> Archived Events
                </a>
            </li>
            <li class="link-slide-in">
