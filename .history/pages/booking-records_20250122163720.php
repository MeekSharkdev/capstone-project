...
<button class='btn btn-primary new-btn' type='button' data-bs-toggle="modal" data-bs-target="#editEmailModal" data-id="<?php echo $row['bookings_id']; ?>" data-firstname="<?php echo $row['firstname']; ?>" data-lastname="<?php echo $row['lastname']; ?>" data-email="<?php echo $row['email']; ?>">
    Edit
</button>
