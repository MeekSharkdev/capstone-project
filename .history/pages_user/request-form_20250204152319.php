...
{
    $query = "SELECT booking_date, firstname, lastname, middle_initial, phonenumber, email, purpose FROM bookings WHERE bookings_id = ? ORDER BY booking_date DESC LIMIT 1";
...
session_start();
$bookings_id = $_SESSION['id'] ?? null;
$booking = $bookings_id ? getBookingDetails($conn, $bookings_id) : null;
?>
