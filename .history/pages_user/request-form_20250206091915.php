...
// Fetch the logged-in user's email (assuming 'username' is the session variable holding the email)
$username = $_SESSION['username'];

// Query to fetch the latest booking for the logged-in user
...
$stmt->bind_param("s", $username);  // Bind the email from session to the query
$stmt->execute();
