...
<body>
    ...
    <div class="container mt-4">
        <h3 class="text-4xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-center text-gray-800 mb-6 border-b-4 border-blue-600 pb-2 tracking-wide leading-tight shadow-lg">
        ...
        <div class="flex justify-between items-center mb-6 px-4 sm:px-2 md:px-4 lg:px-6">
            ...
            <a href="?month=<?= $month == 1 ? 12 : $month - 1 ?>&year=<?= $month == 1 ? $year - 1 : $year ?>"
                class="btn btn-secondary text-xs sm:text-sm md:text-base lg:text-lg px-4 py-2 rounded-lg shadow-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500">
                &laquo; Previous
            </a>

            <!-- Month and Year Header (Centered) -->
            <h3 class="text-xl sm:text-lg md:text-xl lg:text-2xl font-semibold text-gray-700">
