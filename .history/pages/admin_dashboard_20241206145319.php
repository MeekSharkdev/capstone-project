...
$query = "SELECT bookings.bookings_id, bookings.booking_date, 
                 CONCAT(bookings.firstname, ' ', bookings.lastname) AS name, 
                 bookings.email, bookings.purpose
          FROM bookings";
