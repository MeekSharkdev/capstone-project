    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full sm:w-4/5 md:w-3/5 lg:w-2/5">
        ...
        <?php if (!$success) : ?>
            <form method="POST" class="space-y-6">
                ...
                <div class="relative z-10 w-full group"style="z-index: 10;">
                    ...
                    <i class="fa fa-eye absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer" id="toggle-password" onclick="togglePassword()"></i> <!-- Eye icon -->
                </div>
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <i class="fa fa-eye absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer" id="toggle-confirm-password" onclick="toggleConfirmPassword()"></i> <!-- Eye icon -->
                </div>
