            ...
            <form action="contact_submit.php" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="relative z-0 w-full group">
                        <input type="text" id="first_name" name="first_name" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
