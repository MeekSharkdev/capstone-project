        ...
        <div class="bg-gray-700 rounded-lg shadow-2xl dark:bg-gray-700">
            ...
            <div class="p-9 text-white">
                ...
                <div class="mt-9">
                    ...
                    <input type="date" id="newDateInput" class="bg-blue border border-blue-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-md m p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-blue-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                </div>
            </div>
            <!-- Modal footer -->
