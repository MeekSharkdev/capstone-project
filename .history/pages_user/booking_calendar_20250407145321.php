...
<body>
    ...
    <!-- Add a Back button below the calendar, centered -->
            ...
            <form method="POST" class="modal-content" id="bookingForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="firstname" id="firstname" class="form-control" placeholder=" " required oninput="capitalizeFirstLetter(event)">
                    </div>
                    <div class="mb-3">
                        <label for="middle_initial" class="form-label">Middle Initial</label>
                        <input type="text" name="middle_initial" id="middle_initial" class="form-control" maxlength="1" placeholder=" " required oninput="capitalizeFirstLetter(event)">
                    </div>
                    <div class="mb-3">
                        <label for="lastname" class="form-label">Last Name</label>
                        <input type="text" name="lastname" id="lastname" class="form-control" placeholder=" " required oninput="capitalizeFirstLetter(event)">
                    </div>
                    <div class="mb-3">
                        <label for="phonenumber" class="form-label">Phone Number</label>
                        <input type="tel" name="phonenumber" id="phonenumber" class="form-control" required pattern="09\d{9}"
                            oninput="validatePhoneNumber()" title="Phone number must start with 09 and be 11 digits.">
                    </div>
                    <div class="mb-3">
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="finalSubmitBtn">Confirm Booking</button>
