...
<body class="bg-gray-100 h-screen flex justify-center items-center">
        ...
        <?php if (!$success) : ?>
            <form method="POST" class="space-y-6">
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -                    </label>
                    <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer" id="eye-icon-password" onclick="togglePassword()">
                        <i class="fas fa-eye" id="eye-icon-password-eye"></i>
                    </span>
                </div>
                ...
                <div class="mt-4 flex justify-center">
                    <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Register</button>
                </div>
            </form>
        <?php else: ?>
    ...
    <script>
        ...
        function togglePassword() {
            ...
            const eyeIconPassword = document.getElementById('eye-icon-password-eye');
            ...
            // Ensure confirm password field remains hidden
