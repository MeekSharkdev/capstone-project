            ...
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4">
                <div class="text-center p-4 bg-white rounded-lg shadow-md">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 mb-6">
                        <img src="../images/" class="img-fluid w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl transition-transform duration-300 hover:scale-105" alt="Certificate of Indigency">
