...
// Debugging: Log the SQL query to ensure it's correct
$sql = "SELECT booking_date, COUNT(*) AS count FROM bookings WHERE booking_date BETWEEN '$start_date' AND '$end_date' GROUP BY booking_date";
echo "SQL Query: " . $sql;  // Debugging step to check if query is correct
