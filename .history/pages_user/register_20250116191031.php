...
<div class="relative z-10 w-full group">
    ...
    function togglePassword() {
        ...
        console.log(passwordField.type); // Debugging: check the password field type
    ...
    function toggleConfirmPassword() {
        ...
        console.log(confirmPasswordField.type); // Debugging: check the confirm password field type
