...
<head>
    ...
    <style>
        ...
        -->
    <h1 class="text-3xl font-semibold mb-6 text-center text-gray-800">Booking Calendar</h1>
    <div class="flex justify-between items-center mb-6 max-w-lg mx-auto relative">
        <!-- Previous Button -->
        <a href="?month=<?= $month == 1 ? 12 : $month - 1 ?>&year=<?= $month == 1 ? $year - 1 : $year ?>"
            class="flex items-center px-5 py-2.5 bg-blue-600 text-white font-medium rounded-full shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 ease-in-out transform hover:scale-105">
        ...
        <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
            class="flex items-center px-5 py-2.5 bg-green-600 text-white font-medium rounded-full shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-300 ease-in-out transform hover:scale-105">
    ...
    <div class="calendar-container">
        ...
        <div class="calendar">
            ...
            <div class="day limit-reached">3</div>
            <div class="day disabled">4</div>
            <div class="day holiday">5</div>
            <div class="day available">6</div>
            <div class="day booked">7</div>
            <!-- More days as needed -->
        </div>
    </div>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="flex justify-between items-center mb-6 max-w-lg mx-auto relative">
            ...
            <!-- Centered arrow button for sliding -->
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="absolute top-4 left-1/2 transform -translate-x-1/2 bg-green-600 text-white font-semibold rounded-full shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 p-5 flex justify-center items-center transition-all duration-300 ease-in-out">
                <i class="fas fa-chevron-right text-2xl"></i> <!-- Chevron icon -->
            </a>
        </div>
