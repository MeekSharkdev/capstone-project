...
// Debugging: Check if booking data is fetched correctly
if ($booking) {
echo "Booking Data: ";
var_dump($booking); // Output the fetched booking data for debugging
} else {
...
if (!$booking) {
// Set default values in case no booking is found
$booking = [
'firstname' => '',
'middle_initial' => '',
'lastname' => '',
