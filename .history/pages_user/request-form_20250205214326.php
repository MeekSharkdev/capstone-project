...
<body class="bg-gray-200 h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-xl">
        ...
        <form action="" method="POST">
            ...
            <!-- Show the original appointment date -->
            <label class="block font-medium">Original Appointment Date</label>
            <input type="text" value="<?php echo htmlspecialchars($booking['appointment_date'] ?? ''); ?>" readonly class="w-full px-4 py-2 border rounded-lg mb-4 bg-gray-100 text-gray-500">
