...
<body class="relative fade-in" style="background: url('./images/BRGY.__2_-removebg-preview.png') no-repeat center center / cover; width: 100vw; height: 95vh;">
    ...
    <!-- Logo at the top -->
    <div class="text-center mt-9 z-10 relative fade-in">
