...
// Fetch admins from the 'admintbl' database table
$query = "SELECT id, firstname, middlename, lastname, phonenumber, email, birthdate, sex, role, username FROM admintbl ORDER BY id DESC";
...
<head>
    ...
    <title>Manage Admin | Admin</title>
...
<body class="bg-gray-200">
    ...
    <div class="sm:ml-64 p-6">
        ...
        <div class="mb-4 flex justify-center">
            <input type="text" id="searchBar" placeholder="Search for names or details..." class="px-4 py-2 border rounded-lg w-full md:w-1/2 text-gray-700">
        </div>

        <!-- User Table -->
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white">
            <table class="w-full text-sm text-left text-gray-500" id="userTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="12" class="text-center px-6 py-4">No admins found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
