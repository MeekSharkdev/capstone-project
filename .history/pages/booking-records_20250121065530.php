    ...
    <div class="relative p-4 w-full max-w-lg"> <!-- Adjusted width to max-w-lg for medium size -->
        ...
        <div class="bg-gray-700 rounded-lg shadow-2xl dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b dark:border-gray-600">
                ...
                <button type="button" class="text-white-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" id="closeModalBtn">
