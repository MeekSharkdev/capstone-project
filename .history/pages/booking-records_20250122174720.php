                ...
                <script>
                    document.querySelectorAll('.view-btn').forEach(button => {
                        button.addEventListener('click', () => {
                            ...
                            setTimeout(() => {
                                modal.classList.add('transition-all', 'duration-500', 'opacity-100', 'translate-y-0');
                            }, 10);
                        });
                    });

                    // Close modal when clicking close button or outside of modal
                    ...
                    // Event listener for confirming schedule
                    document.getElementById('confirmRescheduleBtn').addEventListener('click', () => {
                        ...
                        const selectedId = document.getElementById('selectedId').value; // Ensure that the selectedId is saved
