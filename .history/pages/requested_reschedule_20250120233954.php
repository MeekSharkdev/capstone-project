...
$query = "
    SELECT 
        users.firstname, 
        users.lastname, 
        requested_reschedule.purpose 
    FROM 
        requested_reschedule
    JOIN 
        users 
    ON 
        requested_reschedule.id = users.id
    ORDER BY requested_reschedule.request_id DESC"; // Assuming 'request_id' is the unique column in 'requested_reschedule'
