...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['resend_otp'])) {
        ...
        $new_expiration_time = date("Y-m-d H:i:s", time() + 120); // 120 seconds expiration
        ...
        try {
            ...
            $mail->Body = "
                <html>
                <body>
                    <p style='font-size: 16px; font-family: Arial, sans-serif;'>Dear User,</p>
                    ...
                    <p style='font-size: 16px; font-family: Arial, sans-serif;'>Please enter this code to complete your verification. The OTP will expire in 2 minutes.</p>
        ...
        if ($current_time > $expiration_time) {
            $otp_error = "You have reached 2 minutes, so your OTP has expired. Please request a new one.";
        } else {
