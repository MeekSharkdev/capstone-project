...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  // Check if passwords match
    ...
    if ($result->num_rows > 0) {
      ...
      $sql = "INSERT INTO admintbl (firstname, middlename, lastname, phonenumber, email, birthdate, sex, role, username, password)
                    VALUES ('$firstname', '$middlename', '$lastname', '$phonenumber', '$email', '$birthdate', '$ag, '$sex', '$role', '$username', '$hashed_password')";
...
<head>
  ...
  <title>Create Admin Acc. | Admin</title>
