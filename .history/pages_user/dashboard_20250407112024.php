...
<body class="bg-gray-200">
    ...
    <div id="welcome-section"
        class="mt-32 mb-20 max-w-full mx-auto bg-gradient-to-r from-gray-700 to-white text-gray shadow-lg rounded-lg p-20 flex items-center gap-8 
    opacity-0 translate-y-10 transition-all duration-700 ease-out">

        <!-- Left Side: Barangay Icon -->
        <div class="flex justify-center">
            <img src="../images/brgy-fav.ico" alt="Barangay Icon" class="w-[180px] h-[180px] rounded-full border-4 border-white shadow-md 
            sm:w-[150px] sm:h-[150px] md:w-[180px] md:h-[180px] lg:w-[200px] lg:h-[200px]">
        </div>

        <!-- Right Side: Greeting and Description -->
        <div class="flex-1">
            <!-- Welcome Message with Typing Animation -->
            <h1 id="welcomeText" class="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-blue-300">
                <!-- Text will be typed dynamically -->
            </h1>
            <p class="text-2xl font-semibold mt-2 text-gray-200">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    if ($counter % 3 == 0 && $counter > 0) {
                        echo "</div><div class='row'>";  // Start a new row after every 3 events
                    }
    ...
    <head>
        <style>
            ...
            /* You can also adjust the card or image styles if needed */
            .card img {
    ...
    <section id="services" class="what-we-do mt-5 animate-up">
        ...
        <div class="row justify-content-center g-4 mx-4">
            <div class="col-10">
                <div class="card text-center">
                    <!-- Combine all images into one card -->
                    <div class="card-body">
                        <h5 class="card-title">Choose Your Certificate</h5>
                        <p class="card-text">Select the appropriate certificate and proceed to book your appointment.</p>

                        <!-- First Image -->
                        <div class="d-flex justify-content-center mb-9">
                            <img src="../images/indigencyNew.jpg" class="img-fluid mx-2" alt="Certificate of Indigency" style="max-width: 400px;">
                            <img src="../images/businesspermit.jpg" class="img-fluid mx-2" alt="Business Permit" style="max-width: 400px;">
                            <img src="../images/brgyclrnc.jpg" class="img-fluid mx-2" alt="Barangay Clearance" style="max-width: 400px;">
                        </div>

                        <!-- Book Button -->
                        <a href="./booking_calendar.php" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
            </div>
        </div>
