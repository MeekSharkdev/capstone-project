...
<body>
  ...
  <div class="sidebar">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 18h4v-6h6v-4h-6V4h-4v4H4v4h6z"/></svg> Dashboard
</a>

<a href="./booking-records.php">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M3 18h18v2H3zM3 12h18v2H3zM3 6h18v2H3z"/></svg> Booking Schedule Records
</a>

<a href="./manage_users.php">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM5 20c0-2.21 3.58-4 7-4s7 1.79 7 4v2H5v-2z"/></svg> User Management
</a>

<a href="./verifying-admin.php">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM5 20c0-2.21 3.58-4 7-4s7 1.79 7 4v2H5v-2z"/></svg> Admin Accounts Verifying
</a>

<a href="../logout-admin.php">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 17l5-5-5-5v4H3v2h7v4zM21 3v18H3V3h18z"/></svg> Logout
</a>
