...
<body class="bg-cover bg-center bg-no-repeat bg-img relative fade-in" style="background-image: url('./images/bg-brgy-staffs.png');">
    ...
    <div class="text-center text-2xl mt-6 font-bold text-gray-300 mt-8 z-10 relative slide-in-left">
        Barangay Appointment Scheduling System
    </div>

    <!-- Logo at the top -->
    <div class="text-center mt-6 z-10 relative fade-in class=" block slide-up">
