...
<head>
    ...
    <style>
        ...
        #mobile-menu {
            ...
            position: fixed;
            /* Make sure it's fixed to the screen */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Hide mobile menu and redirect when a link is clicked
            const mobileLinks = document.querySelectorAll("#mobile-menu a"); // Select all mobile menu links

            mobileLinks.forEach(function(link) {
                link.addEventListener("click", function() {
                    const mobileMenu = document.getElementById("mobile-menu");
                    mobileMenu.classList.remove("show"); // Hide the menu after clicking a link
                    // You don't need to add any extra code for the link to work as expected
                });
            });
        });
    </script>
