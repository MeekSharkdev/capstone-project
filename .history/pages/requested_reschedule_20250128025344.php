...
try {
  ...
  die("Query failed: " . $e->getMessage());
          ...
          function sendApprovalEmail($recipientEmail, $firstname, $original_booking_date, $new_rescheduled_date, $purpose)
          {
            ...
            try {
              ...
              $mail->setFrom('barangaysilangan64@gmail.com', 'Barangay Silangan Admin');
              $mail->addAddress($recipientEmail); // Recipient's email

              // Content
              $mail->isHTML(true);
              $mail->Subject = 'Reschedule Request Approval - Barangay Silangan';

              // Dynamic email body with user details
              $mail->Body = "
            <html>
            <body>
                <p>Dear $firstname,</p>
