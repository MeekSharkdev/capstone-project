    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-2xl mt-10">
        ...
        <div class="mb-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="text-gray-800 pl-4"><?php echo isset($user['phonenumber']) ? htmlspecialchars($user['phonenumber']) : "Not Available"; ?></div>

                <div class="font-medium text-gray-600 text-right pr-4">Email:</div>
                <div class="text-gray-800 pl-4 "><?php echo htmlspecialchars($user['email']); ?></div>
            </div>
        </div>
