...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- View Button Outside Modal -->
            <button class="btn btn-info viewBtn" data-bs-toggle="modal" data-bs-target="#viewModal">View</button>
        </div>
    </div>
    ...
    <div id="viewModal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50">
        <div class="relative p-4 w-full max-w-lg">
            <div class="bg-gray-700 rounded-lg shadow-2xl dark:bg-gray-700">
    ...
    <script>
        ...
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                document.getElementById('viewModal').classList.remove('hidden'); // Show modal
            });
        });

        // Open modal using the "View" button outside the table
        ...
        document.getElementById('closeModalBtn').addEventListener('click', () => {
            document.getElementById('viewModal').classList.add('hidden'); // Hide modal
        });
                ...
                fetch('update_booking_date.php', {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            document.getElementById('viewModal').classList.add('hidden'); // Close the modal
