...
<body class="bg-gray-200">
  ...
  <!-- Text Below the Chart - Responsive Column Layout -->
  <div class="text-center mt-6 space-y-4 md:space-y-0 md:flex md:justify-between md:space-x-6">
    <div class="flex flex-col items-center">
      <span class="text-lg font-semibold">Total Registered Users</span>
      <span class="font-bold text-xl"><?php echo $totalUsers; ?></span>
    </div>
    <div class="flex flex-col items-center">
      <span class="text-lg font-semibold">Total Bookings</span>
      <span class="font-bold text-xl"><?php echo $totalBookings; ?></span>
    </div>
    <div class="flex flex-col items-center">
      <span class="text-lg font-semibold">Completed Users</span>
      <span class="font-bold text-xl"><?php echo $completedUsers; ?></span>
    </div>
  </div>

  <!-- Explanation Text Below the Stats -->
  <div class="text-center mt-6 text-sm italic text-gray-500">
    This chart provides a visual representation of the number of registered users, total bookings made, and the users marked as completed. It helps the admin quickly assess the overall system activity and engagement.
  </div>
</body>
</html>
