    ...
    <div class="container mt-4">
        ...
        <div class="flex justify-between items-center mb-6 max-w-lg mx-auto relative">
            ...
            <a href="?month=<?= $month == 1 ? 12 : $month - 1 ?>&year=<?= $month == 1 ? $year - 1 : $year ?>"
                class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-md hover:bg-blue-700 transition-all duration-300 ease-in-out transform hover:scale-110 absolute left-0 top-1/2 transform -translate-y-1/2 ml-4">
                <i class="fas fa-chevron-left text-lg"></i>
            </a>

            <!-- Month and Year Header -->
            <h3 class="text-xl font-semibold text-gray-700 mx-auto"><?= date('F Y', strtotime("$year-$month-01")) ?></h3>

            <!-- Next Button (Right) -->
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="px-6 py-3 bg-green-600 text-white font-semibold rounded-full shadow-md hover:bg-green-700 transition-all duration-300 ease-in-out transform hover:scale-110 absolute right-0 top-1/2 transform -translate-y-1/2 mr-4">
        ...
        <div class="absolute top-4 left-1/2 transform -translate-x-1/2">
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="p-5 bg-green-600 text-black font-semibold rounded-full shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-300 ease-in-out">
