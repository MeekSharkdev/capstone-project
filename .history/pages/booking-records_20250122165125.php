...
<script>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Confirmation Email</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        // View button logic for Modify modal
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', () => {
                const bookingId = button.getAttribute('data-id');
                const firstname = button.getAttribute('data-firstname');
                ...
                document.getElementById('viewModal').querySelector('#modalName').textContent = `${firstname} ${lastname}`;
                document.getElementById('viewModal').querySelector('#modalEmail').textContent = email;
                document.getElementById('viewModal').querySelector('#modalPurpose').textContent = purpose;
                document.getElementById('viewModal').querySelector('#modalDate').textContent = bookingDate;
