...
<body>
    ...
    <div class="container mt-4">
        <h3 class="text-4xl font-semibold text-center text-gray-800 mb-6 border-b-4 border-blue-600 pb-2 tracking-wide leading-tight shadow-lg">
        ...
        <div class="calendar grid grid-cols-7 gap-2 p-4 sm:grid-cols-7 md:grid-cols-7 lg:grid-cols-7 xl:grid-cols-7">
            <?php
            $today = date('Y-m-d');
