...
$query = "
    SELECT 
        users.firstname, 
        users.lastname, 
        bookings.chosen_date, 
        bookings.purpose_docs, 
        bookings.comments 
    FROM 
        bookings 
    JOIN 
    ...
    ORDER BY bookings.chosen_date DESC";
        ...
        <?php if ($result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
              ...
              <td><?= htmlspecialchars($row['chosen_date']); ?></td>
              <td><?= htmlspecialchars($row['purpose_docs']); ?></td>
              <td><?= htmlspecialchars($row['comments']); ?></td>
            </tr>
          <?php endwhile; ?>
        <?php else: ?>
          <tr>
            <td colspan="5" class="text-center">No reschedule requests found.</td>
          </tr>
        <?php endif; ?>
      </tbody>
    </table>
