        ...
        <?php if (!$success) : ?>
            <form method="POST" class="space-y-6">
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <!-- Eye Icon for Toggle -->
                    <i id="toggle-password" class="fa fa-eye absolute right-0 top-0 mt-2 mr-3 cursor-pointer" onclick="togglePassword()"></i>
                </div>
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <!-- Eye Icon for Toggle -->
                    <i id="toggle-confirm-password" class="fa fa-eye absolute right-0 top-0 mt-2 mr-3 cursor-pointer" onclick="toggleConfirmPassword()"></i>
                </div>
