...
try {
  ...
  die("Query failed: " . $e->getMessage());
          ...
          // Assuming these variables are already set, if not, fetch them from your database
          $firstname = 'John'; // Example, replace with actual dynamic data
          $original_booking_date = '2025-01-25'; // Example, replace with actual dynamic data
          $new_rescheduled_date = '2025-02-05'; // Example, replace with actual dynamic data
          $purpose = 'Barangay Clearance'; // Example, replace with actual dynamic data
          $email = 'john.doe@example.com'; // Example, replace with actual email from your database

          // Prepare the subject and message
          $subject = 'Reschedule Request Approval - Barangay Silangan';
          $message = "
    <html>
    <body>
        <p>Dear $firstname,</p>
        <p>We are pleased to inform you that your request to reschedule the following booking has been approved:</p>
        <table style='border-collapse: collapse; width: 100%;'>
            <tr>
                <td><strong>Original Booking Date:</strong></td>
                <td>$original_booking_date</td>
            </tr>
            <tr>
                <td><strong>New Rescheduled Date:</strong></td>
                <td>$new_rescheduled_date</td>
            </tr>
            <tr>
        ...
        <br>
        <p>Your rescheduled appointment is now confirmed. Please make sure to arrive on the updated date and time. Should you have any further questions or concerns, feel free to reach out to us.</p>
        <br>
        <p>Best regards,<br>
        Barangay Silangan (Cubao)<br>
        <small>If you have any questions, please do not hesitate to contact us at <a href='mailto:support@brgysilangan.com'>support@brgysilangan.com</a>.</small></p>
    </body>
    </html>
";

          // Now call the function
          if (sendApprovalEmail($email, $firstname, $original_booking_date, $new_rescheduled_date, $purpose)) {
