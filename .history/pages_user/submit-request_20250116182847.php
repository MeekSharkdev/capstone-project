...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO request_reschedule (firstname, middlename, lastname, email, date, purpose, reason) 
            VALUES ('$firstname', '$middlename', '$lastname', '$email', '$date', '$purpose', '$reason')";
