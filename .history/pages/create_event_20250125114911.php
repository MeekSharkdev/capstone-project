...
<body class="bg-gray-200 flex place-items-start min-h-screen ml-40">

    <?php include('sidebar.php'); ?>

    <div class="container mx-auto p-4 bg-white rounded-lg shadow-lg w-1/2 mt-10">
        <h1 class="text-2xl text-center font-bold mb-2">Create New Event</h1>
        ...
        <form action="create_event.php" method="POST" enctype="multipart/form-data">
            <div class="grid grid-cols-2 gap-10 py-10 px-12">
                <div>
                ...
                You can achieve this by setting the min attribute of the <input type="date"> field using JavaScript. This ensures that the admin cannot select a date within the next three days.
