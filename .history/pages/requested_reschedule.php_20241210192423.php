...
$query = "
    ...
    JOIN 
        users 
    ON 
        bookings.<CORRECT_COLUMN_NAME> = users.id
    ORDER BY bookings.<CORRECT_BOOKING_COLUMN> DESC";

// Replace <CORRECT_COLUMN_NAME> and <CORRECT_BOOKING_COLUMN> with actual column names.
