...
$query = "SELECT bookings.bookings_id, bookings.booking_date, bookings.name, users.email, bookings.purpose
          FROM bookings 
          INNER JOIN users ON bookings.bookings_id = users.id"; // Fixed join condition
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="confirmBtn">Confirm Schedule</button>
    ...
    <script>
        ...
        document.getElementById('confirmBtn').addEventListener('click', () => {
            // Simulate email sending and status update
            alert('Schedule Confirmed and Email Sent!');
            // Update database status via AJAX or form submission
        });
        ...
        document.getElementById('rescheduleBtn').addEventListener('click', () => {
            ...
            if (newDate) {
                alert(`Schedule Rescheduled to ${newDate}`);
                // Update database with the new date via AJAX
            }
        });
    </script>
</body>
