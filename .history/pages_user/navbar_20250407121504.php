    ...
    <nav class="w-full fixed top-0 left-0 z-50 shadow-lg">
        <div class="max-w-screen-xl mx-auto flex items-center justify-between p-4">
            ...
            <a href="./dashboard.php" class="flex items-center space-x-3">
                <img src="../images/brgy-fav.ico" class="h-8 sm:h-6" alt="Logo" /> <!-- Reduced logo size on mobile -->
                <span class="text-xl font-semibold text-gray-800 hidden sm:block">BRGY.SILANGAN</span> <!-- Hide text on mobile -->
            </a>
            ...
            <div class="relative flex items-center space-x-2">
                <button id="profile-toggle" class="text-gray-800 flex items-center space-x-2 text-lg">
                    <span class="hidden sm:block">Hi, <?php echo htmlspecialchars($username); ?></span>
        ...
        <div id="mobile-menu" class="hidden bg-gray-800 p-4">
            <a href="./dashboard.php" class="text-white hover:text-blue-400 block py-2 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:underline">Home</a>
            <a href="./contact.php" class="text-white hover:text-blue-400 block py-2 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:underline">Contact</a>
            <a href="./profile.php" class="text-white hover:text-blue-400 block py-2 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:underline">Profile</a>
            <a href="./request-form.php" class="text-white hover:text-blue-400 block py-2 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:underline">Reschedule</a>
        </div>
    </nav>
