...
<body>
    ...
    <script>
        ...
        viewBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                modal.classList.remove('opacity-0', 'scale-95'); // Make modal visible with animation
            }, 10);
        });

        // Close modal when the close button is clicked
        closeModalBtn.addEventListener('click', () => {
            modal.classList.add('opacity-0', 'scale-120'); // Add fade-out and scale-down effect
            setTimeout(() => {
                modal.classList.add('hidden'); // Hide the modal after animation
            }, 500); // Match the duration of the fade-out effect (500ms)
        });
