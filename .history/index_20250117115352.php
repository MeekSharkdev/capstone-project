...
<body class="bg-cover bg-center bg-no-repeat bg-img relative" style="background-image: url('./images/bg-brgy-staffs.png');">
    ...
    <div class="flex justify-center mt-12 px-4 z-10 relative">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <!-- Admin Card -->
<div class="bg-white bg-opacity-30 backdrop-blur-lg shadow-lg rounded-lg overflow-hidden transform transition duration-200 hover:scale-105 max-w-xs mx-auto">
    <div class="relative">
