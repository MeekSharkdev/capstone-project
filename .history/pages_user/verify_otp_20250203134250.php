...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['resend_otp'])) {
        ...
        if ($stmt->affected_rows > 0) {
            ...
            $message = "Your new OTP is: $otp. It will expire in 30 seconds.";
            ...
            $otp_error = "Failed to generate a new OTP. Try again.";
        }
        $stmt->close();
    } else {
...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Update expiration time after resending OTP
            <?php if ($otp_resend): ?>
                expirationTime = new Date("<?php echo $new_expiration_time; ?>").getTime();
