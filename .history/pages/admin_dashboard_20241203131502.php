...
<!-- Modal for Viewing and Rescheduling Bookings -->
<div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <!-- Added the correct ID for the Confirm button -->
   ...
   let selectedId; // Declare selectedId globally for use in different event handlers
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', () => {
            ...
            document.getElementById('newDateInput').value = button.getAttribute('data-date'); // Pre-fill date picker
        });
    });

    // Add event listener to handle reschedule confirmation
    ...
    // Event listener for date change to automatically confirm reschedule
    document.getElementById('newDateInput').addEventListener('change', () => {
        if (!selectedId) {
            alert('No booking selected!');
            return;
        }
