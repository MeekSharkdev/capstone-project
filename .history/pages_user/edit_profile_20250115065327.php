                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="sex" name="sex" 
                                        value="<?php echo htmlspecialchars($user['sex']); ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="citizenship" class="form-label">Citizen Ship</label>
                                    <input type="text" class="form-control" id="firstname" name="citizenship" 
                                        value="<?php echo htmlspecialchars($user['firstname']); ?>" required>
                                </div>
                                <div class="mb-3">
