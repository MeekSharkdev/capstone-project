...
<body class="bg-gray-200">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="eventModalLabel"><b>Event Details</b></h3>
                ...
                <div class="modal-body">
                    ...
                    <p><strong>Event Location:</strong> <span id="event-location"></span></p> <!-- Added Event Location -->
    ...
    <script>
        ...
        eventModal.addEventListener('show.bs.modal', function(event) {
            ...
            var location = button.getAttribute('data-location') // Added location
            ...
            var eventLocation = eventModal.querySelector('#event-location') // Added location
            ...
            eventLocation.textContent = location // Set location in modal
