                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 grid grid-cols-subgrid gap-2 col-span-2 ">
                        </div>
                    </div>
                </div>
