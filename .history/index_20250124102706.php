...
<body class="relative fade-in" style="background: url('./images/bg-brgy-staffs.png') no-repeat center center / cover; width: 95vw; height: 95vh;">


    <!-- Gray background overlay to reduce the emphasis on the background image -->
    <div class="absolute inset-0 bg-gray-800 bg-opacity-70 z-0 mx-9 ml-12"></div>

    <!-- Brgy. Silangan Cubao Quezon City text with smooth pop-up effect -->
    <div class="text-center text-2xl mt-6 font-bold text-gray-300 mt-8 z-10 relative pop-up">
        Barangay Document Appointment Scheduling System
    </div>

    <!-- Logo at the top -->
    <div class="text-center mt-6 z-10 relative fade-in">
