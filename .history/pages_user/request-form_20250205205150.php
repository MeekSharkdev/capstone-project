...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert into the database (assuming you have a table for reschedule requests)
    $stmt = $conn->prepare("INSERT INTO reschedule_requests (firstname, middle_initial, lastname, phonenumber, email, request_date, reason) VALUES (?, ?, ?, ?, ?, ?, ?)");
