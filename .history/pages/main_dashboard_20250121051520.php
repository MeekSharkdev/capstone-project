...
<body class="bg-gray-200">
  ...
  <script>
    const ctx = document.getElementById('combinedBarChart').getContext('3d');
    new Chart(ctx, {
      type: 'bar',
      data: {
  ...
  <div class="flex justify-center mt-0 ml-64">
  <div class="w-lg max-w-4xl bg-gray-100 p-4 rounded-2xl shadow-2xl">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <!-- Total Registered Users -->
      <div class="text-center">
        <span class="text-sm font-semibold">Total Registered Users</span>
        <div class="font-bold text-lg"><?php echo $totalUsers; ?></div>
      </div>

      <!-- Total Bookings -->
      <div class="text-center">
        <span class="text-sm font-semibold">Total Bookings</span>
        <div class="font-bold text-lg"><?php echo $totalBookings; ?></div>
      </div>

      <!-- Completed Users -->
      <div class="text-center">
        <span class="text-sm font-semibold">Completed Users</span>
        <div class="font-bold text-lg"><?php echo $completedUsers; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="text-center mt-4 text-sm italic ml-64 text-gray-800 px-6">
