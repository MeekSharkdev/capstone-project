...
// Import SweetAlert if you haven't already (make sure it's included in your project)
...
document.getElementById('confirmRescheduleBtn').addEventListener('click', () => {
    if (!selectedId) {
        Swal.fire({
            ...
            text: 'Please select a booking before proceeding.',
        });
        return;
    }
    ...
    if (newDate) {
        ...
        .then(data => {
            if (data.success) {
                Swal.fire({
                    ...
                    text: 'Schedule successfully rescheduled to ' + newDate,
                });
                ...
                Swal.fire({
                    ...
                    text: 'Failed to reschedule: ' + data.message,
                });
            }
        });
    } else {
        Swal.fire({
            ...
            text: 'Please select a new date before confirming.',
        });
    }
});
