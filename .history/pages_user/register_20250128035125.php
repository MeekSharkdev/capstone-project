...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This code will expire in 1 minutes. If you did not request this code, please ignore this email.</p>
        </div>
        <div class="footer">
            <p>Best regards,<br>Barangay Silangan</p>
            <p><a href="mailto:barangaysilangan64@gmail.com" style="color: #4CAF50;">Contact us</a> for any inquiries.</p>
        </div>
    </div>
</body>
</html>
