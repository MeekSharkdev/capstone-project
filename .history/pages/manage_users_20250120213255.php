...
<body class="bg-gray-200">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-800 text-white">
        <div class="h-full px-3 py-4 overflow-y-auto">
            ...
            <ul class="space-y-2">
                ...
                <li><a href="./booking-records.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded"><i class="fas fa-calendar-check mr-2"></i> Appointmeny Schedule Records</a></li>
    ...
    <div class="sm:ml-64 p-6">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 bg-white rounded-lg shadow-2xl dark:bg-gray-800 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th class="px-4 py-3">Birthplace</th>
                        <th class="px-4 py-3">Gender</th>
                        <th class="px-4 py-3">Civil Status</th>
                        <th class="px-4 py-3">Citizenship</th>
