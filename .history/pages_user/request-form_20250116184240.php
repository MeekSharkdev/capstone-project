    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-md mx-auto bg-white shadow-2xl rounded-lg p-6">
            ...
            <form id="requestForm" action="submit-request.php" method="POST">
                ...
                <button type="button" class="text-white mx- bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5">Back to Dashboard</button>
            </a>
            </form>
        </div>
    </div>
