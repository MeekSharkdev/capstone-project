<?php
include('archive_expired_events.php');
// Connection settings
...
// Perform your query
$query = "SELECT * FROM events WHERE archived = 0";  // Only show non-archived events
...
if (mysqli_num_rows($result) == 0) {
    ...
    $noEventsMessage = "";  // Clear the message if there are events
}
?>
...
<head>
    ...
    <style>
        /* Removing underline and blue color from links */
        a {
        ...
        /* You can set custom link colors here if needed */
        a:hover {
            text-decoration: none;
        ...
        /* Optional: Modify the sidebar if needed */
        .sidebar a {
            color: black;
