...
<body class="bg-gray-200">
        ...
        <tbody>
          ...
          ?>
              <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                  <button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onclick="openEmailForm('<?= htmlspecialchars($row['email']); ?>')">
                    Send Email
                  </button>
                </td>
              </tr>
  ...
  <script>
    ...
    function openEmailForm(email) {
      alert('Email form will open for: ' + email);
      // Here you can implement a modal or redirect to another page with a form
    }
  </script>
