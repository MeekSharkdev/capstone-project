...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-lg">
        ...
        <h2 class="text-xl font-bold mt-8 mb-4">Upcoming Events</h2>
        <!-- Display events -->
                ...
                <div class="bg-white p-4 rounded-lg shadow-lg">
                    <div class="flex justify-center mb-4">
                        <?php if ($event['event_image']): ?>
                            <img src="../uploads/<?php echo htmlspecialchars($event['event_image']); ?>" alt="Event Image" class="w-32 h-32 object-cover rounded-md">
                        <?php else: ?>
                            <div class="w-32 h-32 bg-gray-300 rounded-md flex items-center justify-center text-white">No Image</div>
                        <?php endif; ?>
                    </div>
                    <h3 class="text-lg font-bold"><?php echo htmlspecialchars($event['event_name']); ?></h3>
