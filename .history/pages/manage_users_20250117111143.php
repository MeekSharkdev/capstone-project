    ...
    <div class="sidebar bg-gray-800 text-white w-60 h-full fixed top-0 left-0 p-4">
        ...
        <nav class="mt-8">
            <a href="./main_dashboard.php" class="block py-2 px-4 rounded hover:bg-gray-700 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 5v14m7-7H5" /></svg>
                Dashboard
            </a>
            <a href="./booking-records.php" class="block py-2 px-4 rounded hover:bg-gray-700 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 5h18M3 7v12M21 7v12" /></svg>
                Booking Schedule Records
            </a>
            <a href="./manage_users.php" class="block py-2 px-4 rounded bg-gray-700 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM12 14c-3.31 0-6 2.69-6 6v1h12v-1c0-3.31-2.69-6-6-6z" /></svg>
                User
            </a>
            <a href="./verifying-admin.php" class="block py-2 px-4 rounded hover:bg-gray-700 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 7V4m0 12v-3m5 1l2 2m-10 0L7 18" /></svg>
                Admin Accounts Verifying
            </a>
            <a href="../logout-admin.php" class="block py-2 px-4 rounded hover:bg-gray-700 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M17 9l3-3-3-3M21 12H7" /></svg>
                Logout
            </a>
        </nav>
    </div>
