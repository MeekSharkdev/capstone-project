    ...
    <div class="flex justify-center mt-12 px-4 z-10 relative">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-24 max-w-xl mx-auto mb-14">
            ...
            <a href="./pages_user/login.php" class="block slide-up">
                <div class="bg-white bg-opacity-20 backdrop-blur-lg shadow-lg rounded-lg overflow-hidden transform transition duration-500 hover:scale-105 max-w-56 max-h-64 cursor-pointer">
                    <div class="relative">
