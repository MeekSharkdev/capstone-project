    ...
    <div class="container mx-auto my-10 p-4 max-w-4xl">
        <div class="bg-white shadow-md rounded-lg p-8">
            ...
            <div class="mt-6 text-center">
                ...
                <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-inner hover:bg-blue-600 focus:outline-none">Update Profile</button>
                
                <!-- Cancel Button -->
                <a href="profile.php" class="ml-4 inline-block bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 focus:outline-none">Cancel</a>
            </div>
