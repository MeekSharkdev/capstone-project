...
if (isset($_GET['bookings_id'])) {
    ...
    $query = "SELECT firstname, lastname, middle_initial, phonenumber, email, purpose, bookings_date FROM bookings WHERE bookings_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $middle_initial = $bookings['middle_initial'];
        ...
        $firstname = $lastname = $middle_initial = $phonenumber = $email = $purpose = $bookings_date = "";
    }
} else {
...
<body class="bg-gray-200">
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-7xl mx-auto bg-white shadow-2xl rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1">
                <h2 class="text-2xl font-semibold text-center text-black mb-6">Booking Details</h2>
                <div class="space-y-4">
                    <div><strong>Booking Date:</strong> <?php echo $bookings_date; ?></div>
