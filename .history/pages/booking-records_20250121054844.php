...
document.getElementById('confirmRescheduleBtn').addEventListener('click', () => {
    const alertContainer = document.getElementById('alertContainer'); // Make sure to have a container for alerts in your HTML
    ...
    if (!selectedId) {
        const alertMessage = `
            <div class="alert alert-warning d-flex align-items-center" role="alert">
                ...
                <div>
                    No booking selected! Please select a booking before proceeding.
                </div>
            </div>
        `;
    ...
    if (newDate) {
            ...
            if (data.success) {
                const successMessage = `
                    <div class="alert alert-success d-flex align-items-center" role="alert">
                        ...
                        <div>
                            Schedule successfully rescheduled to ${newDate}.
                        </div>
                    </div>
                `;
                ...
                const errorMessage = `
                    <div class="alert alert-danger d-flex align-items-center" role="alert">
                        ...
                        <div>
                            Failed to reschedule: ${data.message}.
                        </div>
                    </div>
                `;
        ...
        const warningMessage = `
            <div class="alert alert-warning d-flex align-items-center" role="alert">
                ...
                <div>
                    No date selected! Please select a new date before confirming.
                </div>
            </div>
        `;
        alertContainer.innerHTML = warningMessage;
    }
});
