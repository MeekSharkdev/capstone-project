...
$firstname = $lastname = $phonenumber = $email = $request_date = $reason = "";
...
<body class="bg-gray-200 h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-xl">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="firstname" value="<?php echo htmlspecialchars($firstname); ?>" required class="w-full px-4 py-2 border rounded-lg mb-4">
            ...
            <input type="text" name="lastname" value="<?php echo htmlspecialchars($lastname); ?>" required class="w-full px-4 py-2 border rounded-lg mb-4">

            <label class="block font-medium">Phone Number</label>
            <input type="text" name="phonenumber" value="<?php echo htmlspecialchars($phonenumber); ?>" required class="w-full px-4 py-2 border rounded-lg mb-4">

            <label class="block font-medium">Email Address</label>
            <input type="email" name="email" value="<?php echo htmlspecialchars($email); ?>" required class="w-full px-4 py-2 border rounded-lg mb-4">

            <label class="block font-medium">Choose New Date</label>
            <input type="date" name="request_date" value="<?php echo htmlspecialchars($request_date); ?>" required class="w-full px-4 py-2 border rounded-lg mb-4">

            <label class="block font-medium">Reason for Reschedule</label>
            <textarea name="reason" rows="4" required class="w-full px-4 py-2 border rounded-lg mb-4"><?php echo htmlspecialchars($reason); ?></textarea>
