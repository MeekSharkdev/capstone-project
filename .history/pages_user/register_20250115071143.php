            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="relative z-0 w-full group">
                        ...
                        <label for="floating_civilstatus" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Civil Status</label>
                    </div>
                </div>
                ...
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-medium">Register</button>
            </form>
        <?php else : ?>
            <div class="alert alert-success text-green-600 text-sm mb-4">
                Registration successful! You can now <a href="login.php" class="text-blue-600 underline">log in</a>.
            </div>
        <?php endif; ?>
    </div>
    <script>
