...
var_dump($_SESSION); // This will show the current session data
...
if ($stmt = $conn->prepare($query)) {
    // Bind bookings_id to the prepared statement
    ...
    if ($stmt->execute()) {
        ...
        $middle_initial = $booking['middle_initial'] ?? ''; // Handle NULL value gracefully
