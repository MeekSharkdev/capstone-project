...
<body class="bg-gray-200">
  ...
  <div class="text-center mt-4 text-sm italic text-gray-800 px-6">
    This chart provides a visual representation of the number of registered users, <br>total bookings made, and the users marked as completed. <br>It helps the admin quickly assess the overall system activity and engagement.
  </div>
</body>
</html>
