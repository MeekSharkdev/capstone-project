...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $username = $_POST['username']; // Capturing username
    ...
    $stmt = $conn->prepare("INSERT INTO admintbl (firstname, lastname, username, phonenumber, email, birthdate, age, sex, role, password, attachment_form_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    $stmt->bind_param("ssssssssss", $firstname, $lastname, $phonenumber, $email, $birthdate, $age, $sex, $role, username$password_hashed, $attachment_form_id);
