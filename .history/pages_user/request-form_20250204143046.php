    ...
    <div class="max-w-7xl mx-auto bg-white p-8 rounded-lg shadow-xl mt-10 grid grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <p><strong>Middle Initial:</strong> <?php echo htmlspecialchars($booking['middle_initial'] ?? ''); ?></p>
                <p><strong>Phone Number:</strong> <?php echo htmlspecialchars($booking['phonenumber'] ?? ''); ?></p>
                <p><strong>Email Address:</strong> <?php echo htmlspecialchars($booking['email'] ?? ''); ?></p>
