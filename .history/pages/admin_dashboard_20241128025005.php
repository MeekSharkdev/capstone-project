...
<body>
  ...
  <script>
    ...
    var confirmRescheduleDiv = document.getElementById('confirmRescheduleDiv');
    var datepickerDiv = document.getElementById('datepickerDiv');
    var newDateInput = document.getElementById('newDate');
    var confirmRescheduleBtn = document.getElementById('confirmRescheduleBtn');
    ...
    viewModal.addEventListener('show.bs.modal', function (event) {
      ...
      bookingRow = document.getElementById('row' + button.getAttribute('data-id'));
    ...
    // Show the datepicker when Reschedule is clicked
    ...
    // Confirm reschedule and update the table
    confirmRescheduleBtn.addEventListener('click', function () {
      var newDate = newDateInput.value;
      if (newDate) {
        // Update the date in the modal and table
        appointmentDateField.value = newDate;
        bookingRow.querySelector('.appointmentDate').textContent = newDate;
