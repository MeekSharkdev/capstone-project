...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-800 text-white">
    <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <div class="flex justify-center mb-4">
            <img src="path/to/brgy-logo-remove.png" alt="Barangay Logo" class="h-16 w-auto">
        </div>
        ...
        <div class="mt-auto text-center text-sm text-gray-300">
            <?php
                // Assuming the session or user object holds the first name of the admin
                echo "Hi Admin, " . htmlspecialchars($_SESSION['first_name']);
            ?>
        </div>
    </div>
</aside>
