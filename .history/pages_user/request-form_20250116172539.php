            ...
            <form action="submit-request.php" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                    <div class="relative z-0 w-full group">
                        ...
                        <label for="floating_first_name" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">First Name</label>
                    </div>
                    <div class="relative z-0 w-full group">
                        ...
                        <label for="floating_middle_name" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Middle Name</label>
                    </div>
                    <div class="relative z-0 w-full group">
                        ...
                        <label for="floating_last_name" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Last Name</label>
                    </div>
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_email" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Email Address</label>
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="date" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Choose Date</label>
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="purpose" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Purpose (Documents)</label>
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="reason" class="absolute text-sm text-gray-500 duration-300 transform top-3 left-0 origin-[0] peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:text-blue-600 peer-focus:text-xs">Reason for Request</label>
                </div>
