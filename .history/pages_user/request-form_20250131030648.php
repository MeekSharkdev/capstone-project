...
if (isset($_GET['booking_id'])) {
    ...
    if ($stmt = $conn->prepare($query)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $firstname = $lastname = $middle_initial = $phonenumber = $email = $purpose = $booking_date = "No data found.";
        }
    } else {
    ...
    $firstname = $lastname = $middle_initial = $phonenumber = $email = $purpose = $booking_date = "Booking ID is missing.";
}
?>
