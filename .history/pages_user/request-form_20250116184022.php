    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-md mx-auto bg-white shadow-2xl rounded-lg p-6">
            ...
            <form id="requestForm" action="submit-request.php" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit" class="text-white mx-9 gap- bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit Request</button>
