...
<body>
    ...
    <script>
        ...
        // Modal open and close functionality with animation
        ...
        viewBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                modal.classList.remove('opacity-0', 'translate-y-10'); // Make modal visible with smooth pop-up
            }, 10);
        });

        // Close modal when the close button is clicked
        closeModalBtn.addEventListener('click', () => {
            modal.classList.add('opacity-0', 'translate-y-10'); // Add fade-out and slide-down effect
            setTimeout(() => {
