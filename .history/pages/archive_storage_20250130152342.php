...
if (isset($_GET['delete_id'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        header("Location: archived_events.php?status=deleted");
    } else {
        // Handle error
    ...
    <div class="sm:ml-64 p-6">
        ...
        <?php if (isset($_GET['status']) && $_GET['status'] == 'deleted'): ?>
            <div id="alert" class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Warning!</strong> The event was deleted permanently.
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <!-- Delete Button -->
                                <a href="?delete_id=<?php echo $row['id']; ?>" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 ml-2" onclick="return confirm('Are you sure you want to permanently delete this event?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
