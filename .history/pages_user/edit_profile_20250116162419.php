...
<body class="bg-gray-200">
    <div class="container mx-auto my-10 p-4 max-w-4xl">
        <div class="bg-white shadow-full rounded-lg p-8">
            ...
            <form method="POST">
                ...
                <div class="flex justify-between">
                    <button type="submit" class="px-6 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300">Save Changes</button>
                    <a href="profile.php" class="px-6 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-300">Cancel</a>
                </div>
            </form>
        </div>
    </div>
