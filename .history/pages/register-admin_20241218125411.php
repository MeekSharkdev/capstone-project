...
<head>
    ...
    <style>
        /* Make the disabled placeholder options gray and visible */
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="sex" name="sex" required>
                    ...
                    <option value="" disabled>---</option> <!-- Extra disabled placeholder -->
            ...
            <div class="mb-3">
                <label for="role" class="form-label label-blue">Select Role</label>
