...
<!-- Modal toggle -->
<button id="viewBtn" class="block text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gry700 dark:focus:ring-blue-800" type="button">
  View Booking
</button>
