    ...
    <div class="container mt-4">
        ...
        <div class="flex justify-between items-center mb-6 max-w-lg mx-auto">
            ...
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="absolute top-4 left-1/2 transform -translate-x-1/2 bg-green-600 text-white font-semibold rounded-full shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 p-4 flex justify-center items-center transition-all duration-300 ease-in-out">
                <span class="text-3xl">&gt;</span> <!-- '>' as the 'greater than' symbol -->
            </a>
