...
<script>
    ...
    // Function to open modal with correct data
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', function () {
                selectedId = this.getAttribute('data-id');
                document.getElementById('modalName').textContent = this.getAttribute('data-firstname') + " " + this.getAttribute('data-lastname');
                document.getElementById('modalEmail').textContent = this.getAttribute('data-email');
                document.getElementById('modalPurpose').textContent = this.getAttribute('data-purpose');
                document.getElementById('modalDate').textContent = this.getAttribute('data-date');
                document.getElementById('newDateInput').value = this.getAttribute('data-date');
                document.getElementById('newPurposeInput').value = this.getAttribute('data-purpose');
    ...
    document.getElementById('confirmRescheduleBtn').addEventListener('click', function () {
        ...
        console.log("Updating Booking:", selectedId, newDate, newPurpose); // Debugging
