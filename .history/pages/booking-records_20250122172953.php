...
viewBtn.addEventListener('click', () => {
    modal.classList.remove('hidden'); // Show the modal initially
    setTimeout(() => {
        modal.classList.add('transition-all', 'duration-500', 'opacity-100', 'translate-y-0'); // Smooth slide-up and fade-in effect
    }, 10);
});
...
closeModalBtn.addEventListener('click', () => {
    ...
    modal.classList.add('opacity-0', 'translate-y-10'); // Add slide-down and fade-out effect
    setTimeout(() => {
