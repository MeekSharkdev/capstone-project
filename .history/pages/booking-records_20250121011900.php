...
<!-- Sidebar -->
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform transform bg-gray-800 text-white">
    <div class="h-full px-3 py-4 overflow-y-auto">
        <h4 class="text-center text-lg font-bold mb-4">Admin Panel</h4>
        <ul class="space-y-2">
            <li><a href="./main_dashboard.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'main_dashboard' ? 'bg-gray-700' : '' ?>"><i class="fas fa-tachometer-alt mr-2"></i> Dashboard</a></li>
            <li><a href="./booking-records.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'booking-records' ? 'bg-gray-700' : '' ?>"><i class="fas fa-calendar-alt mr-2"></i> Appointment Management</a></li>
            <li><a href="./requested_reschedule.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'requested_reschedule' ? 'bg-gray-700' : '' ?>"><i class="fas fa-redo-alt mr-2"></i> Rescheduling Request</a></li>
            <li><a href="./manage_users.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'manage_users' ? 'bg-gray-700' : '' ?>"><i class="fas fa-users mr-2"></i> User Management</a></li>
            <li><a href="./manage_admin.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'manage_admin' ? 'bg-gray-700' : '' ?>"><i class="fas fa-user-shield mr-2"></i> Manage Admins</a></li>
            <li><a href="./create_admin.php" class="flex items-center px-4 py-2 hover:bg-gray-700 rounded <?= $current_page == 'create_admin' ? 'bg-gray-700' : '' ?>"><i class="fas fa-user-shield mr-2"></i> Create Admin</a></li>
