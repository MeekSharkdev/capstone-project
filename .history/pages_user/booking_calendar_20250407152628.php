    ...
    <div class="container mt-4">
        ...
        <div class="flex justify-between items-center mb-6 max-w-lg mx-auto relative">
            ...
            <a href="?month=<?= $month == 12 ? 1 : $month + 1 ?>&year=<?= $month == 12 ? $year + 1 : $year ?>"
                class="px-6 py-3 bg-green-600 text-black font-semibold rounded-full shadow-md hover:bg-green-700 transition-all duration-300 ease-in-out transform hover:scale-110 absolute right-0 top-1/2 transform -translate-y-1/2 mr-4">
